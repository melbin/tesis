...
<script type="text/javascript">
	var accion_excel="<?php echo base_url('home/consultas/imprimir_solicitud_finalizada/1'); ?>";
 	var accion_pdf="<?php echo base_url('home/consultas/imprimir_solicitud_finalizada/2'); ?>";
</script>
        ...
        <div class="panel-body">
        	...
        	<table width="70%" align="left" border="0" style="margin-top:30px;">
        		...
        		<td width="10%"><label>Departamento:</label></td>
        			<td colspan="3">
        				<select class="form-control select2" id="depto" name="depto" placeholder="seleccione">
        					<?php echo (isset($deptos))? $deptos:null; ?>
        				</select>	
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#buscar").on('click',function(){
			...
			$.ajax({
	            url: urlj+'home/consultas/imprimir_solicitud_finalizada',
	            type: 'POST',
	            dataType: 'json',
	            data: {id_depto : $("#depto").val(), fecha_in: $("#fecha_inicio").val(), fecha_out: $("#fecha_fin").val() },
	            success:function(data) {
	            	$("#id_depto").val($("#depto").val());
                    ...
                    $("#td_temporal").attr("colspan",7); // Pendiete
                    $(".drop").remove();
	            }
	        });
