...
<script type="text/javascript">
	var accion_excel="<?php echo base_url('home/consultas/imprimir_solicitud_rechazo/1'); ?>";
 	var accion_pdf="<?php echo base_url('home/consultas/imprimir_solicitud_rechazo/2'); ?>";
</script>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#buscar").on('click',function(){
			...
			$.ajax({
	            url: urlj+'home/consultas/imprimir_solicitud_rechazo',
	            type: 'POST',
	            dataType: 'json',
