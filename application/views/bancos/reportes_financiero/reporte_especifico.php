...
<script type="text/javascript">
	var accion_excel="<?php echo base_url('bancos/reportes_financiero/get_detalle_especifico/1'); ?>";
 	var accion_pdf="<?php echo base_url('bancos/reportes_financiero/get_detalle_especifico/2'); ?>";
</script>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#buscar").on('click',function(){
			...
			if( $.trim($("#fondo").val())!='' && $.trim($("#fondo").val())>0 && $("#especifico").val() > 0 )
			{	

			$.ajax({
	            url: urlj+'bancos/reportes_financiero/get_detalle_especifico',
	            type: 'POST',
	            dataType: 'json',
