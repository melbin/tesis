...
<script type="text/javascript">
    var accion_excel="<?php echo base_url('bancos/reportes_financiero/get_detalle_fondo/1'); ?>";
    var accion_pdf="<?php echo base_url('bancos/reportes_financiero/get_detalle_fondo/2'); ?>";
</script>
<div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table width="70%" align="left" border="0" style="margin-top:30px;">
                ...
                <tr> <!-- <i id="requerido">*</i> -->
                <td><label>Fondo:<b style="color:red;">*</b></label></td>
                    <td colspan="3">
    ...
    $(document).ready(function(){
        ...
        $("#buscar").on('click',function(){
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: {id_fondo : $("#fondo").val(), fecha_in: $("#fecha_inicio").val(), fecha_out: $("#fecha_fin").val() },
                success:function(data) {
